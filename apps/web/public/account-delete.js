(() => {
  ...
  const install = () => {
    ...
    const open = () => {
      ...
      overlay.style.cssText = 'position:fixed;inset:0;z-index:2147483001;background:rgba(15,23,42,.62);display:grid;place-items:center;padding:20px;font-family:system-ui';
